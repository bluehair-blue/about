...
- commit: schema·D1 domain helper `b5d2a33`; taxonomy `e58dbfa`; asset manifest/retention `e040f31`; draft autosave는 현재 local working tree checkpoint
...
- Go/No-Go: schema·D1 domain helper·taxonomy·asset manifest/retention·draft autosave 단계 local Go. Phase B 전체와 staging migration은 미통과
